cd ..
python run_fashion_pyramid_occ+attn_different_net.py --id=4_flow_attn_loss_with_flow_reg_lambda5_pose_aware_pyramid_pretrain_occ_attn_different_net_flow35 \
 --K=2 --gpu=0 \
