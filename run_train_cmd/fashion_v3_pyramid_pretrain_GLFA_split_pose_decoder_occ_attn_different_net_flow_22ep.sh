cd ..
python run_fashion_pyramid_occ+attn_different_net.py --id=3_pose_aware_pyramid_pretrain_GLFA_split_occ_attn_different_net_flow22 --K=2 --gpu=0 \
 ...
 --which_flow_epoch 'epoch_22_batch_4000_G'
