...
#  --test_id='market_v3_residual_flow_single_correctness_loss_non_align_input_2shot_20220118' \
#  --K=2\
#  --gpu=0 \
#  --phase 'test' \
#  --align_corner  \
...
# --distorated_path /home/ljw/playground/poseFuseNet/test_result/market_v3_residual_flow_single_correctness_loss_non_align_input_2shot_20220118/epoch_2_batch_0_G/2_shot_eval/ \
# --fid_real_path /dataset/ljw/market/train  \
# --name market_v3_res_flow_highres_non_align_input_ep2_0_2shot
...
# CUDA_VISIBLE_DEVICES=0 python -m script.metrics_market \
# --gt_path /dataset/ljw/market/test  \
# --distorated_path /home/ljw/playground/poseFuseNet/test_result/market_v3_residual_flow_single_correctness_loss_non_align_input_2shot_20220118/epoch_2_batch_5000_G/2_shot_eval/ \
# --fid_real_path /dataset/ljw/market/train  \
# --name market_v3_res_flow_highres_non_align_input_ep2_5k_2shot
...
CUDA_VISIBLE_DEVICES=0 python -m script.metrics_market \
--gt_path /dataset/ljw/market/test  \
--distorated_path /home/ljw/playground/poseFuseNet/test_result/market_v3_residual_flow_single_correctness_loss_non_align_input_2shot_20220118/epoch_2_batch_10000_G/2_shot_eval/ \
--fid_real_path /dataset/ljw/market/train  \
--name market_v3_res_flow_highres_non_align_input_ep2_1w_2shot
...
CUDA_VISIBLE_DEVICES=0 python -m script.metrics_market \
--gt_path /dataset/ljw/market/test  \
--distorated_path /home/ljw/playground/poseFuseNet/test_result/market_v3_residual_flow_single_correctness_loss_non_align_input_2shot_20220118/epoch_2_batch_15000_G/2_shot_eval/ \
--fid_real_path /dataset/ljw/market/train  \
--name market_v3_res_flow_highres_non_align_input_ep2_1w5_2shot
...
CUDA_VISIBLE_DEVICES=0 python -m script.metrics_market \
--gt_path /dataset/ljw/market/test  \
--distorated_path /home/ljw/playground/poseFuseNet/test_result/market_v3_residual_flow_single_correctness_loss_non_align_input_2shot_20220118/epoch_1_batch_15000_G/2_shot_eval/ \
--fid_real_path /dataset/ljw/market/train  \
--name market_v3_res_flow_highres_non_align_input_ep1_1w5_2shot
