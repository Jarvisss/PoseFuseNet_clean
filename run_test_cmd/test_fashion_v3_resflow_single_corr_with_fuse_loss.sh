...
python run_fashion_pyramid_decoder_residual_flow.py \
 --test_id='fashion_v3_residual_flow_with_fuse_loss_single_reg_single_correctness_loss_align_input_2shot_20210412' \
 --K=2\
 --n_res_block=1\
 --gpu=1\
 --phase 'test' \
 ...
 --test_ckpt_name 'epoch_31_batch_15000_G'\
 --use_pose_decoder
#  --test_samples 200\
#  --output_all
#  --use_bone_RGB\
...
--distorated_path /home/ljw/playground/poseFuseNet/test_result/fashion_v3_residual_flow_with_fuse_loss_single_reg_single_correctness_loss_align_input_2shot_20210412/epoch_31_batch_15000_G/2_shot_eval/ \
--fid_real_path /home/ljw/playground/Global-Flow-Local-Attention/dataset/fashion/train_256  \
--name v3_highres_align_input_res_flow_single_corr_with_fuse_loss_ep31_15k_2shot
